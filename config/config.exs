...
config :civic_flux, CivicFluxWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: CivicFluxWeb.ErrorHTML, json: CivicFluxWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: CivicFlux.PubSub,
  live_view: [signing_salt: "zSUxI8bk"]
...
config :civic_flux, CivicFlux.Mailer, adapter: Swoosh.Adapters.Local
